/* [grial-metadata] id: Grial#EmployeePerformanceDashboardViewModel.cs version: 1.0.6 */
...
namespace arabasorgula
{
    public class EmployeePerformanceDashboardViewModel : ObservableObject
    {
        ...
        public EmployeePerformanceDashboardViewModel(FlowEmployeeData employee, INavigation navigation)
        {
        ...
        {
            await _navigation.PushAsync(new EmployeeProfileDashboardPage(Employee));
        }
    }
}
